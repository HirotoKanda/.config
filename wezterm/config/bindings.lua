...
local keys = {
   ...
   -- tabs: navigation
   { key = 'q',          mods = mod.SUPER,     action = act.ActivateTabRelative(-1) },
   { key = 'e',          mods = mod.SUPER,     action = act.ActivateTabRelative(1) },
   { key = 'q',          mods = mod.SUPER_REV, action = act.MoveTabRelative(-1) },
   { key = 'e',          mods = mod.SUPER_REV, action = act.MoveTabRelative(1) },
   ...
   -- panes: navigation
   { key = 'l',     mods = mod.SUPER_REV, action = act.ActivatePaneDirection('Up') },
